...
public class BtListActivity extends Activity {
    ...
    // 调试用
    private static final String TAG = "BteListActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter<>(this, R.layout.bt_name);
        mNewDevicesArrayAdapter = new ArrayAdapter<>(this, R.layout.bt_name);
